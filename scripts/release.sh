...
- optionally running unit tests, smoke tests, and build
...
Options:
  ...
  --skip-verify      Skip SABX_E2E_DISABLE=1 make test, make smoke, and make build
...
Examples:
  ...
  ./scripts/release.sh 0.1.9 --no-auto-merge
EOF
}
